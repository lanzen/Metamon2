...
# Change to locateion of SilvaMod (CREST installation dir/LCAClassifier/parts/flatdb/silvamod)
db_dir=/share/databases/CREST/silvamod

# Change to location of bash scripts, fasta_merging.py and  matrix_creation.py (from SLIM),  and fasta_number.py (from vsearch)
